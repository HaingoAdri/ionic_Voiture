...
function Section() {
  ...
  useEffect(() => {
    ...
    if (storedSessionString) {
      ...
      //liste des annonces
      get(`https://vente-occaz-production-nomena.up.railway.app/api/v1/annonces/non-vendues-nofiltre/${sess.donnee.utilisateur.idUtilisateur}`, sess.donnee.token).then(reponse => {
